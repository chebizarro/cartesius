...
;(function (window, document, undef) {
    ...
    */
    ...
    var Stapling = function () {
        ...
        * @returns {Void}
        */
        var _parse = function (xmlDocument, xslDocument, callback, param) {
            ...
            callback.call(result, xmlDocument,param);
        ...
        */
        ...
        return {
            ...
            * @returns {Void}
            */
            parse: function (json, template, callback, param) {
                ...
                if (this.cachable && (cached = _retrieve(template)) !== false && cached != null) {
                    ...
                    _parse(xmlDocument, xslDocument, callback, param);
            ...
            * @returns {Void}
            */
            load: function (service, template, callback, param) {
                ...
                if (this.cachable && (cached = _retrieve(service)) !== false && cached != null) {
                    ...
                    me.parse(JSON.parse(cached), template, callback, param);
                    ...
                    _request(service, function (json) {
                        ...
                        me.parse(JSON.parse(json), template, callback, param);
