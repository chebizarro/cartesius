define(function(require) {
    ...
    var Boiler = require('Boiler'),
        arcticThemePath = require('path!/lib/jqwidgets/jqwidgets/styles/jqx.arctic.css'),
        metroThemePath = require('path!/lib/jqwidgets/jqwidgets/styles/jqx.metro.css');
	 ...
	 */
	var themes = {
		arctic : arcticThemePath,
		metro : metroThemePath
	};
