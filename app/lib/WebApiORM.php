<?php
    ...
    class ORM extends \ORM {
        ...
        public static function get_tables($connection_name) {
			$sql = "SELECT table_name 
					FROM information_schema.tables
					WHERE table_type = 'BASE TABLE' 
					AND table_schema NOT IN ('pg_catalog', 'information_schema');";
		
			return self::get_db($connection_name)->query($sql)->fetchAll(PDO::FETCH_ASSOC);		
		}
		
		public static function get_columns($table_name, $connection_name) {
			$sql = "SELECT *
        ...
        /*
         *    SELECT tc.constraint_name AS key,
          kcu.column_name,
tc.constraint_type
...
*/
        ...
        public static function get_primary_key($table_name, $connection_name) {
			$sql = "SELECT tc.constraint_name AS pkey, kcu.column_name
					FROM information_schema.table_constraints tc
					LEFT JOIN information_schema.key_column_usage kcu
					ON tc.constraint_catalog = kcu.constraint_catalog
					AND tc.constraint_name = kcu.constraint_name
        ...
        public static function get_foreign_keys($table_name, $connection_name) {
			$sql = "SELECT
					...
					AND (ccu.table_name = '{$table_name}' OR tc.table_name = '{$table_name}')";
